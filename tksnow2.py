...
class SnowAnimation:
    def __init__(self, root, canvas_width, canvas_height, num_snowflakes):
        ...
        # Draw the horizon (ground) - adjust as needed
        horizon_height = 100  # Height of the horizon from the bottom
        self.canvas.create_rectangle(0, canvas_height - horizon_height, canvas_width, canvas_height, fill='gray', outline='gray')
...
if __name__ == "__main__":
    root = tk.Tk()
    root.title("Snow Animation with Horizon")
