...
class FileExplorer:
    ...
    def create_ui(self):
        ...
        self.paned_window.add(self.tree_frame, minsize=200)
        ...
        # Create a frame for the file listbox
        self.listbox_frame = ttk.Frame(self.paned_window)
        self.paned_window.add(self.listbox_frame, minsize=400)

        # Create a listbox for the file list
        self.file_listbox = tk.Listbox(self.listbox_frame)
        self.file_listbox.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)

        # Create a scrollbar for the listbox
        self.listbox_scrollbar = ttk.Scrollbar(self.listbox_frame, orient=tk.VERTICAL, command=self.file_listbox.yview)
